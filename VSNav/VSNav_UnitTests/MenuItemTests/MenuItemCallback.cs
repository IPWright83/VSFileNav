...
namespace VSNav_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSNavPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(VSNav.GuidList.guidVSNavCmdSet, (int)VSNav.PkgCmdIDList.quickFindFile);
