...
namespace VSNav_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(VSNav.GuidList.guidVSNavCmdSet, (int)VSNav.PkgCmdIDList.quickFindFile);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VSNav", "IanWright.VSNav.VSNavPackage");
